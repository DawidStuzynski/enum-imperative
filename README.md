...
It is replication projet for bug in quarus related to saving enums in database 
...
You can then execute your native executable with: `./build/enum-imperative-1.0.0-SNAPSHOT-runner`
